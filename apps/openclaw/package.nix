...
let
  ...
  src = fetchurl {
    ...
    hash = "sha512-5Pn5hcRDVv3eeWYDp4IPPuvyz3yD+Vrdobykl/vi35/49ZldWUz02pDT5rTGMCInDelNZGaWoXAfm5vFdqha8g==";
  };
in
buildNpmPackage {
  pname = "openclaw";
  ...
  npmDepsHash = "sha256-conSLnTplg8gYKjjuazAW/Tp7+yamLTd/Zbua2Mzuqs=";
  sourceRoot = "package";
