...
let
  ...
  platformMap = {
    "aarch64-darwin" = {
      suffix = "darwin-arm64";
      hash = "sha256-WJ7deOrsncrc2fuaTKCAyxrlonqZ4CxTH9t8aOcINyM=";
    };

    "x86_64-darwin" = {
      suffix = "darwin-x64";
      hash = "sha256-DW6B2g3bbutLp7LUjQ1rhUKax5UXcc21y/JabpjQ9S8=";
    };
    ...
    "aarch64-linux" = {
      suffix = "linux-arm64";
      hash = "sha256-NLw2lAjQdW1VTakRpypTWgdrOrLjh1+aKprJ4SX2U2U=";
    };
  };
