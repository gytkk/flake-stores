...
let
  ...
  platformMap = {
    "aarch64-darwin" = {
      suffix = "darwin-arm64";
      hash = "sha256-e5nloROfSRWqpKxQXYKtt4rAjBJ9fEVDh14lnt3uzeo=";
    };

    "x86_64-darwin" = {
      suffix = "darwin-x64";
      hash = "sha256-i4RGvsj+TLXZoI4eIbh3j2rs2Mx0Jsz7TE0iqmHM8RA=";
    };
    ...
    "aarch64-linux" = {
      suffix = "linux-arm64";
      hash = "sha256-BHhqm61Seiv7pDIwe1Aqk6q8QEPnBysqGyCs88hrdN4=";
    };
  };
