...
let
  ...
  src = fetchurl {
    ...
    hash = "sha512-mxq3IClhdgmCrYiKuzKehs4QKCVJgKmlA70nUEzsgeNsGdxriT7o5sKQTCcxzVJkzDRMcHD/8tAP4/eGrV4gKQ==";
  };
in
buildNpmPackage {
  pname = "pi";
  ...
  npmDepsHash = "sha256-9/5j9+ionccqjGhZJHK2HCiVGDk3VvYxzX5p5l6fs80=";
  sourceRoot = "package";
