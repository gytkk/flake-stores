...
let
  ...
  src = fetchurl {
    ...
    hash = "sha512-GPYFuHw1BN+3m5Gzw1HGH41WdFDzbplLauS0zYSf1ZOkgKFd6wtEAcjchB/vmz9YtTGbQOwECbsVj6GxZxungA==";
  };
in
buildNpmPackage {
  pname = "pi";
  ...
  npmDepsHash = "sha256-RqBfFERLNbkPr5sqyZly/qZVfvrnlNo/GOpY4ubDrRI=";
  sourceRoot = "package";
