...
let
  ...
  platformMap = {
    "aarch64-darwin" = {
      suffix = "darwin-arm64";
      hash = "sha256-hbwia6z7TNgPD94OjFTkyLAdSi06J9QiybBZjG1OQtw=";
    };

    "x86_64-darwin" = {
      suffix = "darwin-x64";
      hash = "sha256-mwXkJXCO7CvqkHt41R0OZnTAtH2yiGJPOfYwmBtdknA=";
    };
    ...
    "aarch64-linux" = {
      suffix = "linux-arm64";
      hash = "sha256-+dt5ZxwMhKZdJYqCPyMsNDiUPbl3xyS1xE3VGBOSqIY=";
    };
  };
