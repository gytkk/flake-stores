...
let
  ...
  platformMap = {
    "aarch64-darwin" = {
      suffix = "darwin-arm64";
      hash = "sha256-M85qP5QyKtjqSsKNuSNzfAQNuIr4uxmfV3eJldRR8sc=";
    };

    "x86_64-darwin" = {
      suffix = "darwin-x64";
      hash = "sha256-4RlnkcIC4Rh1282X3nRLCI9alPNwaz87T6kFalotVis=";
    };
    ...
    "aarch64-linux" = {
      suffix = "linux-arm64";
      hash = "sha256-KBzOjj6esR/YI7E8CFmW1zYcNZI61FTOXLBqVRVjDps=";
    };
  };
